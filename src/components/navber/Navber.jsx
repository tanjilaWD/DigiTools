    ...
    return (
        ...
        <nav className='container mx-auto flex justify-between my-4 font-semibold items-center'>
            ...
            <div className='flex gap-5'>
             ...
             <button className='bg-gradient-to-r from-[#4F39F6] to-[#9514FA] text-white px-4 py-3 rounded-4xl font-bold cursor-pointer hover:from-red-500 hover:to-yellow-500 transition-all duration-300 '>Get Started</button>
            </div>
        </nav>
